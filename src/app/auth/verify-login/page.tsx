            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="h-14 rounded-2xl border bg-white/5 px-4 pr-12 text-black placeholder:text-zinc-500 focus-visible:ring-2 focus-visible:ring-yellow-500 dark:border-white/10 dark:text-white"
                  required
                />
