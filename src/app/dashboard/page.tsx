...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 p-4 sm:p-6 lg:p-8">
      <div className="relative overflow-hidden rounded-3xl border border-black bg-gradient-to-br from-white via-white to-amber-50/40 p-8 shadow-sm dark:border-white dark:from-zinc-950 dark:via-zinc-950 dark:to-amber-950/10">
        ...
        <div className="relative flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
          <div className="space-y-5">
            ...
            <div className="space-y-3">
              <Skeleton className="h-12 w-full max-w-[520px] rounded-2xl" />
              <Skeleton className="h-5 w-full max-w-[620px] rounded-full" />
              <Skeleton className="h-5 w-full max-w-[460px] rounded-full" />
            </div>
          </div>
      ...
      <div className="grid items-stretch gap-6 lg:grid-cols-[1.6fr_1fr]">
        <Card className="relative flex flex-col justify-between overflow-hidden rounded-[2.5rem] border border-black bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-zinc-900 via-zinc-950 to-black text-white shadow-2xl shadow-zinc-950/50 dark:border-white">
          <div className="absolute -right-20 -top-20 h-48 w-48 rounded-full bg-emerald-500/10 blur-[60px]" />

          <CardContent className="relative z-10 flex h-full min-h-[260px] flex-col justify-between p-6 sm:p-8 md:p-9">
            <div className="flex w-full items-start justify-between">
              <div className="space-y-4">
                <Skeleton className="h-4 w-44 rounded-full bg-zinc-800" />
                <Skeleton className="h-14 w-80 max-w-full rounded-2xl bg-zinc-800" />
              </div>
               <Skeleton className="h-12 w-12 rounded-2xl bg-zinc-800" />
            </div>

            <div className="mt-8 flex w-full flex-row items-center gap-3">
              <Skeleton className="h-12 flex-1 rounded-xl bg-zinc-800" />
              <Skeleton className="h-12 flex-1 rounded-xl bg-zinc-800" />
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
          <Card className="rounded-[2rem] border border-black bg-gradient-to-b from-white to-zinc-50/50 shadow-sm dark:border-white dark:from-zinc-950 dark:to-zinc-950/40">
      ...
      <Card className="rounded-[2.5rem] border border-black bg-white shadow-sm dark:border-white dark:bg-zinc-950">
         ...
         <CardContent className="p-6 sm:p-8">
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            {Array.from({ length: 4 }).map((_, index) => (
              <div
                key={index}
                className="rounded-2xl border border-black bg-zinc-50/50 p-5 dark:border-white/20 dark:bg-zinc-900/30"
              >
        ...
        <Card className="rounded-[2.5rem] border border-black bg-white shadow-sm dark:border-white dark:bg-zinc-950">
        <CardHeader className="flex flex-row items-center justify-between px-6 pb-2 pt-6 sm:px-8">
          <div className="space-y-3">
        ...
        <CardContent className="space-y-3 px-6 pb-6 sm:px-8 sm:pb-8">
          {Array.from({ length: 5 }).map((_, index) => (
            <div
              key={index}
              className="flex items-center justify-between rounded-xl border border-black/20 bg-white p-4 dark:border-white/20 dark:bg-zinc-950"
            >
...
<div className="grid gap-6 lg:grid-cols-[1.6fr_1fr] items-stretch">
  ...
  className="flex-1 h-12 rounded-xl dark:bg-white bg-black font-medium text-white dark:text-black hover:bg-[#D4AF37] shadow-[0_4px_12px_rgba(255,255,255,0.15)] dark:shadow-none transition-all duration-200 active:scale-[0.985]"
>
  <ArrowDownLeft className="mr-2 h-4 w-4 stroke-[2.5] text-white dark:text-black" />
  Fund Wallet
</Button>
        <Button
          onClick={() => router.push("/dashboard/wallet")}
