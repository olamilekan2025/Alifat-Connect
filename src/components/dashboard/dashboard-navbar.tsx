...
export function DashboardNavbar() {
  ...
  return (
    <>
      <header className="sticky top-0  z-50 flex h-16 items-center justify-between border-b border-black bg-white px-4  transition-[left,width] duration-200 ease-in-out dark:border-white/30 dark:bg-black dark:border-white md:px-6 md:pl-2">
        {/* LEFT */}
