...
export default function AdminNavbar() {
  ...
  <>
    ...
    {/* NAVBAR */}
    <div className="sticky top-0 z-40 border-b border-white/10 bg-gradient-to-r from-black/60 via-zinc-900/40 to-black/60 backdrop-blur-2xl">
...
<Input
  ...
  className="h-11 w-full rounded-2xl border border-white/10 bg-white/5 pl-10 text-white placeholder:text-zinc-500 focus-visible:ring-yellow-500/30"
/>
        </div>
        ...
        <div className="order-1 flex w-full items-center justify-end gap-3 sm:order-2 sm:w-auto">
          {/* NOTIFICATIONS */}
          <button className="relative flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-white/5 transition hover:bg-white/10">
          ...
          >
            <button
              ...
              className="flex items-center gap-2 rounded-2xl border border-white/10 bg-white/5 px-2 py-2 transition hover:bg-white/10 sm:gap-3 sm:px-4"
            >
